...
class SoSTruck:
    ...
    def load_truck(self):
        ...
        while not self.is_full() and len(packages_to_load) > 0:
            ...
            if package.get_special_note() and package.get_special_note()[0] in [
                SoSPackage.SPECIAL_NOTE_TYPE.DELAYED.value, SoSPackage.SPECIAL_NOTE_TYPE.WRONG_ADDRESS.value]:
                continue
